            ...
            <div className="container about-container">
                <div className="row align-item-center">
                    <div className="col-lg-8 col-md-10">
                        ...
                        <p className="text-capitalize lead">give a girl the right heel and she can conquar the world.</p>
                    ...
                    <div className="col-md d-flex flex-row flex-lg-column justify-content-around align-items-center">
                        <div className="about-square-img center-content">
                            <img alt="heel" src={colorfulShoe} className="img-fluid" />
                        </div>
                        <div className="about-square-img center-content">
                            <img alt="heel" src={pinkShoe} className="img-fluid" />
                        </div>
                        <div className="about-square-img center-content">
                            <img alt="heel" src={blackShoe} className="img-fluid" />
                        </div>
                    </div>
                </div>
            </div>
